...
@section('content')
  ...
  <style>
    ...
    <h1 class="my-5 border-bottom">Modification mots de passe Enseignant</h1>
  ...
  <tbody>
    <tr>
      <td>Modifier</td>
      <td><a href ="/modify-nom-prenom"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
